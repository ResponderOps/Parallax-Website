...
window.addEventListener('scroll', function () {
    ...
    fish1.style.transform = `translateY(${value * 0.25}px)`;
    fish2.style.transform = `translateY(${-value * 0.2}px)`;
    fish3.style.transform = `translateY(${value * 0.18}px)`;
    fish4.style.transform = `translateY(${-value * 0.15}px)`;
})
